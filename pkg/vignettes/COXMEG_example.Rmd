...
In the results, the column ```score_test``` is the score test statistic, which follows a $\chi^2$ distribution with 1 d.f. The column ```score``` is the score function normalized by its variance.
